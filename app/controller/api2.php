                      ...
                      <table class="table mb-3">
                        ...
                        <tbody>
                            ...
                            <td>https://<?=$_SERVER['HTTP_HOST']?>/api/v2</td>
                                                  ...
                                                  <tr>
                            <td>Bot</td>
                            <td><a href="https://t.me/<?=$bot?>"><?=$bot?></a></td>
                          </tr>
                                                </tbody>
                      </table>
                    </div>
                ...
                <pre>
{
  ...
  <script type="text/javascript" src="https://<?=$site_url?>/style/js/1.js">
      </script>
  <script type="text/javascript" src="https://<?=$site_url?>/style/js/2.js">
      </script>
  <script type="text/javascript" src="https://<?=$site_url?>/style/js/3.js">
      </script>
