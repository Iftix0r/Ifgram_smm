...
$j=json_decode(get($m['api_url']."?key=".$m['api_key']."&action=services"),1);
foreach($j as $ve){
...
mysqli_query($connect,"UPDATE services SET service_min='$min', service_max='$max', service_price='$rp' WHERE service_id=$doi");
